...
import { THE_FRIDGE_MODULES } from '../constants';
...
const TheFridgeView = () => {
    ...
    return (
        <div className="page">
            ...
            <BottomNavbar activePage="theFridge" onNavigate={onNavigate} />
        </div>
    );
};

export default TheFridgeView;