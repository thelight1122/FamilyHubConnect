...
import type { Badge, PageView, ModuleDefinition, PersonalizationData, Chore, FamilyMessage, ShoppingListItem, FamilyEvent, BookLogEntry, SafeWebsite, Trip, Transaction, Photo, PhotoAlbum, SavingsGoal, Infraction, Profile, AdultDetailForm, ChildDetailForm, Habit, HabitLog, ShoutOut, Todo } from '../types';
...
export const ALL_NAV_ITEMS: { page: PageView; label: string; icon: string }[] = [
    { page: 'dashboard', label: 'Dashboard', icon: '🏠' }, { page: 'chores', label: 'Chores', icon: '📋' }, { page: 'todo', label: 'To-Do', icon: '✅' }, { page: 'rewards', label: 'Rewards', icon: '🏆' },
