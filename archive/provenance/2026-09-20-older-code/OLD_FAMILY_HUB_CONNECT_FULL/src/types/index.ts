...
import type { PersonalizationData } from './personalization';
...
export type PageView =
    ...
    | 'weatherWidget' | 'dashboardSettings' | 'caregivingCentral' | 'integrations' | 'activities' | 'digitalFridge'
    | 'events' | 'habitTracker' | 'familyConstitution' | 'todo' | 'todoSettings';
