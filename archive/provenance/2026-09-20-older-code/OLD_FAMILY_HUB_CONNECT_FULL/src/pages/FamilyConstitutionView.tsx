...
export default function FamilyConstitutionView() {
    const { 
        ...
        profiles, getProfileName, onNavigate
    } = useAppContext();
    ...
    return React.createElement('div', { style: styles.pageContainer },
        React.createElement('button', { onClick: () => onNavigate('familyMatters'), style: { ...styles.backButton, float: 'left' } }, "← Back"),
        React.createElement('div', { style: { clear: 'both' } }),
        React.createElement('h2', { style: styles.pageHeader }, "📜 Family Constitution"),
