  ...
  return (
    <div className="min-h-dvh bg-[#f6f7f8]">
      ...
      <div className="bg-[#4c8ce6] text-white rounded-2xl mx-4 mt-4 p-5">
        ...
        <p className="text-4xl font-black mb-1">${finances.totalSavings.toLocaleString()}</p>
      ...
      <div className="mx-4 mt-6">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs bg-blue-50 text-[#4c8ce6] px-2 py-1 rounded-full font-medium">Active</span>
          </div>
          ...
          <div className="mb-2">
            ...
            <div className="w-full bg-slate-100 rounded-full h-2.5">
              <div className="bg-[#4c8ce6] h-2.5 rounded-full transition-all" style={{ width: `${progress}%` }} />
            </div>
          </div>
      ...
      <div className="mx-4 mt-6">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs bg-green-100 text-green-600 px-3 py-1 rounded-full font-semibold">Paid Off</span>
          </div>
        </div>
      </div>
      ...
      <div className="mx-4 mt-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm space-y-3">
          ...
          <div className="flex items-start gap-3">
            <span className="material-symbols-outlined text-[#4c8ce6] mt-0.5">check_circle</span>
            <p className="text-sm text-slate-700">All family loans are 0% interest and there are no hidden fees.</p>
          </div>
        </div>
      </div>
    </div>
