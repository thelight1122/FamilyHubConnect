    ...
    <div className="min-h-dvh w-full max-w-md mx-auto bg-background-light flex flex-col">
      ...
      <div className="flex-1 bg-white rounded-t-3xl px-8 pt-8 pb-10 shadow-lg">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input defaultValue="password" type="password" className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all text-slate-900" />
            </div>
          </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-8">
          New family?{' '}
          <button onClick={() => navigate(paths.onboardingValues)} className="text-primary font-bold hover:underline">
            Create Account
          </button>
        </p>
      </div>
